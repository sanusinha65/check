    ...
    return (
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        >
          ...
          >
            Get Personalized LinkedIn Posts
            <motion.div 
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Drop your LinkedIn profile, and we’ll turn it into ready-to-use posts in seconds so you can start growing today. For free.
          </motion.p>
          ...
          <motion.div 
            ...
            >
                <div className="flex flex-col w-full">
                    <label htmlFor="urlInput" className="text-gray-800 text-xl font-bold mb-2">LinkedIn URL</label>
                    <input
                        id="urlInput"
                        type="text"
                ...
                <div className="flex flex-col w-full mt-4 sm:mt-0">
                    <label htmlFor="otherInput" className="text-gray-800 text-xl font-bold mb-2">Email Address</label>
                    <input
                        id="otherInput"
                        type="text"
                ...
                <button
                    className="px-6 py-3 bg-gradient-to-r self-start from-purple-600 to-indigo-600 text-white font-semibold rounded-md hover:opacity-90 transition mt-4 sm:mt-0"
                >
                   Generate Content
                </button>
            </motion.div>
