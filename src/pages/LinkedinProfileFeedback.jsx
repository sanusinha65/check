      ...
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Use the power of AI to generate optimization suggestions for your LinkedIn profile. For free.
          </motion.p>
          ...
          <motion.div 
            ...
            >
                <div className="flex flex-col w-full">
                    <label htmlFor="urlInput" className="text-gray-600 font-semibold mb-2">Paste your profile url</label>
                    <input
                        id="urlInput"
                        type="text"
...
function LinkedinProfileFeedback()
{
  return (
    <>
    <Header/>
