...
function CookiePolicy() {
  return (
    <>
      <Meta 
        title="Outx.ai Cookie Policy" 
        description="Find out how Outx.ai uses cookies to improve your LinkedIn scraping and tracking experience." 
        keywords="Outx.ai cookies, LinkedIn scraper cookies, cookie policy LinkedIn" 
      />
      <Header />
