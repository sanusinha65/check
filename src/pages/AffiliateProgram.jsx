...
function AffiliateProgram() {
  return (
    <>
    <Meta 
      title="Outx.ai Affiliate Program - Earn by Promoting Outx.ai" 
      description="Join the Outx.ai affiliate program and earn commissions by helping others grow with LinkedIn scraping and tracking." 
      keywords="LinkedIn affiliate program, Outx.ai affiliate, earn with LinkedIn tools" 
    />
    <Header/>
