...
import { boostContent } from '../api/supabase';

function Banner() {

  useEffect(() => {
    const handleBoostContent = async () => {
      console.log("api called")
      try {
        await boostContent(
          "Excited to be part of the team and looking forward to our new journey!"
        );
      } catch (error) {
      ...
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            Improve your LinkedIn posts with OutX's powerful AI. Format your posts for readability and improve your posts for maximum viral potential.
          </motion.p>
          ...
          <motion.div 
            ...
            >
                <div className="flex flex-col w-full">
                    <label htmlFor="urlInput" className="text-gray-600 font-semibold mb-2">Your Post Content</label>
                    <textarea
                        id="urlInput"
