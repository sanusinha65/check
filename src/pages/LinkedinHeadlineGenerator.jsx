      ...
      <section className="relative overflow-hidden min-h-screen flex items-center justify-center">
        ...
        >
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            A LinkedIn Headline Generator using AI to generate highly engaging LinkedIn headlines to get more profile visits
          </motion.p>
          ...
          <motion.div 
            ...
            >
                <div className="flex flex-col w-full">
                    <label htmlFor="urlInput" className="text-gray-600 font-semibold mb-2">I am a...</label>
                    <input
                        id="urlInput"
                        type="text"
...
function LinkedinHeadlineGenerator()
{
  return (
    <>
    <Header/>
